...
/// Page to update user profile / logout
...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.pageBirthday = currentUserDocument?.birthday;
      safeSetState(() {});
    });
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PROFILE_PAGE_FeedbackButton_ON_TAP');
                          logFirebaseEvent('FeedbackButton_bottom_sheet');
                          ...
                          logFirebaseEvent('FeedbackButton_backend_call');
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('PROFILE_PAGE_LogOutButton_ON_TAP');
                        ...
                        options: FFButtonOptions(
                          ...
                          color: Color(0x005F7A61),
                          textStyle:
                              FlutterFlowTheme.of(context).subTitles.override(
                                    font: GoogleFonts.roboto(
                                      fontWeight: FontWeight.w500,
                                      fontStyle: FlutterFlowTheme.of(context)
                                          .subTitles
