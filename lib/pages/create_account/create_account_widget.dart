                ...
                children: [
                      ...
                      children: [
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                contentPadding: EdgeInsetsDirectional.fromSTEB(
                                    24.0, 27.0, 24.0, 27.0),
                                suffixIcon: _model.setupNameTextController!.text
                                        .isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                                          _model.setupNameTextController
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                contentPadding: EdgeInsetsDirectional.fromSTEB(
                                    24.0, 27.0, 24.0, 27.0),
                                suffixIcon: _model.setupSchoolTextController!
                                        .text.isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                                          _model.setupSchoolTextController
                              ...
                              enableInteractiveSelection: true,
                              validator: _model
                                  .setupSchoolTextControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CREATE_ACCOUNT_SET_BIRTHDAY_BTN_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'CREATE_ACCOUNT_COMPLETE_PROFILE_BTN_ON_T');
